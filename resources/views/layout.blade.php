        ...
        <div class="col-8 col-lg-12 px-0">
            <div class="row mx-0 justify-content-between align-items-end align-items-xl-center">
                <div
                    ...
                    <div class="catalog d-flex flex-column shadow visually-hidden position-absolute"
                        ...
                        @foreach( $catalogMenu as $catalogItem)
                            <a href="/categories/{{$catalogItem['link']}}"
                ...
                <div
                    ...
                    <button type="button" class="shopping-card position-relative" data-shopping-card>
        ...
        <div class="menu-mobile__content position-relative" data-menu-content>
            ...
            <div class="menu-mobile__body">
                <div class="menu-mobile__list d-flex flex-column align-items-start">
                    ...
                    <button type="button"
                            class="link-active link-active--header d-flex flex-row align-items-start position-relative"
                            data-shopping-card>
                ...
                <div class="menu-mobile__catalog">
                    ...
                    <div class="d-flex flex-column">
                        <a href="/categories/turbines" class="link-active link-active--header">Турбины</a>
                        <a href="/categories/cartridges" class="link-active link-active--header">Картриджи</a>
                        <a href="/categories/geometries" class="link-active link-active--header"
                        >Геометрии</a
                        >
                        <a href="/categories/actuators" class="link-active link-active--header">Актуаторы</a>
                        <a href="/categories/servos" class="link-active link-active--header">Сервоприводы</a>
                        <a href="/categories/gaskets" class="link-active link-active--header">Прокладки</a>
                        <a href="/categories/spares" class="link-active link-active--header">Прочие запчасти</a>
                        <a href="/categories/electronic-vacuum-vctuators" class="link-active link-active--header">Электронновакуумные
                            актуаторы</a>
                        <a href="/categories/turbine-housings" class="link-active link-active--header">Корпуса
                            турбины</a>
                        <a href="/categories/servo-parts" class="link-active link-active--header">Запчасти для
                            сервопривода</a>
                    </div>
                </div>
